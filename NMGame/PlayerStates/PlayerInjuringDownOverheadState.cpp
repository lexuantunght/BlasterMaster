#include "PlayerInjuringDownOverheadState.h"
#include "PlayerStandingDownOverheadState.h"
PlayerInjuringDownOverheadState::PlayerInjuringDownOverheadState(PlayerData* playerData)
{
...
PlayerInjuringDownOverheadState::~PlayerInjuringDownOverheadState()
{
}

void PlayerInjuringDownOverheadState::Update(float dt)
{
...
void PlayerInjuringDownOverheadState::HandleKeyboard(std::map<int, bool> keys)
{
    if (keys[VK_UP])
    {
...
void PlayerInjuringDownOverheadState::OnCollision(Entity* impactor, Entity::SideCollisions side, Entity::CollisionReturn data)
{
...
PlayerState::StateName PlayerInjuringDownOverheadState::GetState()
{
    return PlayerState::InjuringDownOverhead;
}