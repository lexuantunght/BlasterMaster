...
#define WIN_NAME "Blaster Master"
#define WIN_TITLE "Blaster Master"
#define FPS 60
...
int                     mCmdShow;
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpStrCmdLine, _In_ int nShowCmd)
{
